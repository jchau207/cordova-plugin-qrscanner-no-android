...
Forked to disable Android functionality.

A fast, energy efficient, highly-configurable QR code scanner for Cordova apps – available for the iOS, Windows, and browser platforms.
